...
^!F1::
{
   SetDefaultEndpoint(GetDeviceID(Devices, "HiFi Audio"))
   SetDefaultEndpoint(GetDeviceID(Devices, "Logitech Webcam C925e"))
   return
}

^!F2::
{
    SetDefaultEndpoint(GetDeviceID(Devices, "HyperX Cloud II Wireless"))
    ; SetDefaultEndpoint(GetDeviceID(Devices, "HyperX Cloud II Wireless"))
    return
}
...
SetDefaultEndpoint(DeviceID)
{
    ...
    DllCall(NumGet(NumGet(IPolicyConfig+0)+13*A_PtrSize), "UPtr", IPolicyConfig, "UPtr", &DeviceID, "UInt", 1, "UInt")
